    ...
    <div class="seccion w3-light-grey ">
        ...
        <div style="overflow-x:auto;">
            ...
            <display:table pagesize="${pageSize}"
                ...
                <acme:column property="registrationMoment" title="label.date" sortable="true" format="moment.format"/>
                    ...
                    <jstl:forEach items="${userIsFollowedMap}" var="entry">
                        <jstl:if test="${entry.value}">
                            <tr>
                                ...
                                <td><fmt:formatDate value="${entry.key.registrationMoment}" pattern="${datePattern}"/> </td>
