...
<jstl:set var="owns"
          value="${logedActor.id == route.user.userAccount.id}"/>

<jstl:set var="readonly"
          value="${(display || !owns || !edition) && route.id != 0}"/>
    ...
    <form:form action="${requestUri}" modelAttribute="route">
        ...
        <div class="seccion w3-light-grey">
            <div class="row">
                <div class="col-100">
                    <legend>
                        <spring:message code="label.route"/>
                    </legend>
                    <div class="row">
                        <div class="col-25">
...
<jstl:set value="${route.id}" var="routeId"/>

<%@ include file="/views/hike/list.jsp" %>